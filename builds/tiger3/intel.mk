...
#ISA_OPT = -march=core-avx-512 -qno-opt-dynamic-align
#ISA_REPRO = -march=core-avx-512 -qno-opt-dynamic-align
#ISA_DEBUG = -march=core-avx-512 -qno-opt-dynamic-align
ISA_OPT   = -xCORE-AVX512 -qno-opt-dynamic-align
ISA_REPRO = -xCORE-AVX512 -qno-opt-dynamic-align
ISA_DEBUG = -xCORE-AVX512 -qno-opt-dynamic-align
endif
...
FFLAGS_DEBUG = -g -O0 -check -check noarg_temp_created -check nopointer -warn -warn noerrors -fpe0 -ftrapv $(ISA_DEBUG)
...
LIBS += -L/opt/intel/oneapi/mpi/2021.13/lib
